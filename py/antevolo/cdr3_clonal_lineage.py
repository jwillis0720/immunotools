...
class CDR3LineageConstructor:
    def __init__(self, dataset, output_dir):
        ...
        self.cdr3_fasta_dir = os.path.join(self.output_dir, 'cdr3_fasta')
        self.cdr3_graph_dir = os.path.join(self.output_dir, 'cdr3_graphs')
        self.connected_comp_dir = os.path.join(self.output_dir, "cdr3_connected_components")
    ...
    def _OutputCDR3sByLengthLevels(self):
        ...
        for l in levels:
            ...
            self.file_distance_dict[fname] = l / length_level * 6
    ...
    def _ConstructCDR3GraphsByLengthLevel(self):
        ...
        for f in fasta_files:
            ...
            print "  Constructing Hamming graph on " + full_path + '...'
            base_name = f.split('.')[0]
